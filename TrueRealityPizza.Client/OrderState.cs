...
public class OrderState
{
	...
	public async Task GetStateFromLocalStorage(IJSRuntime jsRuntime)
	{
		...
		var locallyStoredState = await jsRuntime.InvokeAsync<string>("sessionStorage.getItem", "TrueRealityPizza.orderState");
	...
	public async Task SaveStateToStorage(IJSRuntime jsRuntime)
	{
		...
		await jsRuntime.InvokeVoidAsync("sessionStorage.setItem", "TrueRealityPizza.orderState", stateAsJson);
